...
# Fit Stage 2 Ridge model on Day 49 train with stable alpha=50.0
print("Fitting Stage 2 Ridge regression model (alpha=50.0)...")
...
# Blending weights configurations (using stable alpha=50.0)
blends = {
    "T7": 0.40, # 40% Two-Stage, 60% GBDT
    "T8": 0.35, # 35% Two-Stage, 65% GBDT
    "T9": 0.45, # 45% Two-Stage, 55% GBDT
    "T10": 0.30 # 30% Two-Stage, 70% GBDT
}

for name, w in blends.items():
    print(f"Generating {name} submission with weight {w:.2f} Two-Stage (alpha=50.0)...")
...
print("="*60)
print("All optimized blends generated successfully!")
print("="*60)
